...
export const useLoginMicrosoft = () => {

    const CLIENT_ID = 'c4bc2141-3964-4a04-a459-70c4e74bb6f5'
    const AUTHORITY = 'https://login.microsoftonline.com/7e761206-66fa-448b-a3e6-6c0660e38ed5'
    ...
    function getAuthProvider() {
        api.get('apiRoutes.quser.authProviders').catch((err) => { 
            console.error(err);
        });
    }
